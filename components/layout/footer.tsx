        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-6">
            ...
            <p className="text-white/70 text-sm leading-relaxed">
              Professional ceramic tableware manufacturer providing wholesale & OEM/ODM services worldwide.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/factory" className="text-white/70 hover:text-white text-sm transition-colors">
                  Factory
                </Link>
              </li>
              <li>
