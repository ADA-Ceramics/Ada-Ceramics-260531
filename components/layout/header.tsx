...
export function Header() {
  ...
  const navItems: {
    ...
    {
      name: "Dinnerware",
      href: `/${currentLangCode}/products/dinnerware`,
      dropdown: [
        { name: "Dinnerware Sets", href: `/${currentLangCode}/products/dinnerware-sets` },
        { name: "Plates", href: `/${currentLangCode}/products/plates` },
        { name: "Bowls", href: `/${currentLangCode}/products/bowls` },
        { name: "Serve Dishes", href: `/${currentLangCode}/products/serve-dishes` },
      ],
    },
    {
      name: "Bakeware",
      href: `/${currentLangCode}/products/bakeware`,
      dropdown: [
        { name: "Ramekin Bowls", href: `/${currentLangCode}/products/ramekin-bowls` },
        { name: "Baking Dishes & Casseroles", href: `/${currentLangCode}/products/baking-dishes-casseroles` },
        { name: "Loaf & Pie & Pizza Pans", href: `/${currentLangCode}/products/loaf-pie-pizza-pans` },
      ],
    },
    {
      name: "Table Decor & Drinkware",
      href: `/${currentLangCode}/products/table-decor-drinkware`,
      dropdown: [
        { name: "Cups & Mugs", href: `/${currentLangCode}/products/cups-mugs` },
        { name: "Vases", href: `/${currentLangCode}/products/vases` },
        { name: "Storage & Condiment Jars", href: `/${currentLangCode}/products/storage-condiment-jars` },
        { name: "Serving Trays", href: `/${currentLangCode}/products/serving-trays` },
        { name: "Candle Holders", href: `/${currentLangCode}/products/candle-holders` },
      ],
    },
    {
      name: "OEM Custom Ceramics",
      href: `/${currentLangCode}/oem-odm`,
      dropdown: [
        { name: "Custom Logo Printing", href: `/${currentLangCode}/oem-odm` },
        { name: "Custom Glaze & Color", href: `/${currentLangCode}/oem-odm` },
        { name: "New Mold Development", href: `/${currentLangCode}/oem-odm` },
        { name: "OEM & ODM Project Case Studies", href: `/${currentLangCode}/oem-odm` },
