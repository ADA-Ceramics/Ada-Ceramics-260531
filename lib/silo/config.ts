...
const dinnerware: SiloConfig = {
  ...
  subcategories: [
    ...
    },
    {
      ...
      href: "/products/oval-serving-plates",
  ...
  procurement: {
    ...
    tags: [
      { label: "Restaurant Dinnerware", href: "/products/plates" },
      { label: "Hotel Tableware", href: "/products/dinnerware-sets" },
      { label: "Catering Bulk Bowls", href: "/products/bowls" },
      { label: "Buffet Serve Dishes", href: "/products/oval-serving-plates" },
      { label: "Private-Label Sets", href: "/oem-odm" },
    ],
  },
  faqs: [
    {
...
const tableDecorDrinkware: SiloConfig = {
  ...
  subcategories: [
    ...
    },
    {
      ...
      href: "/products/storage-condiment-jars",
  ...
  procurement: {
    ...
    tags: [
      { label: "Café Drinkware", href: "/products/cups-mugs" },
      { label: "Branded Gift Mugs", href: "/oem-odm" },
      { label: "Hospitality Decor Vases", href: "/products/vases" },
      { label: "Kitchen Storage Jars", href: "/products/storage-condiment-jars" },
      { label: "Retail Home Accents", href: "/products/candle-holders" },
    ],
  },
  faqs: [
    {
